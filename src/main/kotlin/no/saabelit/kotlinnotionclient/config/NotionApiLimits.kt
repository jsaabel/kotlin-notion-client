...
object NotionApiLimits {
    ...
    object Utils {
         ...
         */
        fun truncateRichText(text: String, suffix: String = "..."): String {
         ...
         */
        fun <T> chunkArray(items: List<T>, maxSize: Int = Collections.MAX_ARRAY_ELEMENTS): List<List<T>> {
            return items.chunked(maxSize)
        }
    }
}