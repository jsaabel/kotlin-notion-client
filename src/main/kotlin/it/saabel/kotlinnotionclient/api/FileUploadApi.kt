...
import it.saabel.kotlinnotionclient.models.files.FileUploadList
import it.saabel.kotlinnotionclient.models.files.createFileUploadRequest
...
class FileUploadApi(
    ...
    suspend fun uploadFileMultiPart(
        ...
        val upload =
            createFileUpload(
                CreateFileUploadRequest(
                    mode = it.saabel.kotlinnotionclient.models.files.FileUploadMode.MULTI_PART,
                    filename = filename,
                    contentType = contentType,
    ...
    suspend fun importExternalFile(
        ...
        createFileUpload(
            CreateFileUploadRequest(
                mode = it.saabel.kotlinnotionclient.models.files.FileUploadMode.EXTERNAL_URL,
                filename = filename,
                contentType = contentType,
