...
object TestFixtures {
     ...
     */
    fun loadSampleResponse(category: String, filename: String): JsonElement {
     ...
     */
    fun loadSampleResponseAsString(category: String, filename: String): String {
        val resourcePath = "/api/$category/$filename.json"
...
inline fun <reified T> JsonElement.decode(): T {
    return Json { ignoreUnknownKeys = true }.decodeFromJsonElement(kotlinx.serialization.serializer<T>(), this)
}