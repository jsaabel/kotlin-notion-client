        ...
        "Should upload file and create media blocks from uploads" {
            ...
            if (token != null && parentPageId != null) {
                ...
                try {
                    ...
                    // Create file upload
                    val createRequest = CreateFileUploadRequest(
        ...
        "Should demonstrate complete media workflow with mixed sources" {
            ...
            if (token != null && parentPageId != null) {
                ...
                try {
                    ...
                    val mediaCount = blocks.count { it is Block.Image || it is Block.Video || it is Block.Audio || it is Block.File || it is Block.PDF }
