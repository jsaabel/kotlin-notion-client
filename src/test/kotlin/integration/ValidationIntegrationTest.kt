                ...
                test("should fail fast on long content within paragraph blocks") {
                    ...
                    val pageRequest =
                        CreatePageRequest(
                            ...
                            properties =
                                mapOf(
                                    "title" to PagePropertyValue.TitleValue(title = listOf(createNormalRichText("Block Validation Test"))),
                                ),
                        )
                    val page = client.pages.create(pageRequest)
                ...
                test("should validate mixed block types with rich text content") {
                    ...
                    val pageRequest =
                        CreatePageRequest(
                            ...
                            properties =
                                mapOf(
                                    "title" to PagePropertyValue.TitleValue(title = listOf(createNormalRichText("Mixed Block Types Test"))),
                                ),
                        )
                    val page = client.pages.create(pageRequest)
