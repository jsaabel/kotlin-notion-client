                                    ...
                                    mapOf(
                                        "title" to
                                            PagePropertyValue.TitleValue(
                                                title = listOf(RequestBuilders.createSimpleRichText("Comments Test Page - Kotlin Client")),
                                            ),
                                    ),
                            )
            ...
            When("testing comments with file attachments") {
                ...
                Then("should successfully create comments with file attachments") {
                    ...
                    try {
                            ...
                            CreatePageRequest(
                                ...
                                properties =
                                    mapOf(
                                        "title" to
                                            PagePropertyValue.TitleValue(
                                                title = listOf(RequestBuilders.createSimpleRichText("File Attachment Comments Test")),
                                            ),
                                    ),
                            )
                        ...
                        val testFileContent = "This is a test file for comment attachments.\nGenerated by integration test."
                        val uploadResult =
